...
-	Det er behov for trikom å handle på storcash, vi trenger ting på kontoret.
-	Dette semesteret har det vært lite tilgang til bil, derfor har det vært lite ting på kontoret. Mange medlemmer synes det er leit.
-	HS har sett på mulighetene for å leie bil, men dette er veldig dyrt.
-	Kanskje vi kan kjøpe bil? Det kan også bli veldig dyrt, og parkering er dyrt.
...
-	Poenget er at tilbudet på kontoret er et godt tilbud, men vi er ikke en kiosk. Men hvis vil kjøper bil kan den brukes flere ganger, fadderukene, leie til andre, hvert arrkom-arrangement.
-	Kan være nyttig for fagkom for å bestille mat som ikke kan leveres.
...
-	Har vi sett på det å lease en bil? Ja, det er svindyrt.
o	Det betyr 4000 i mnd. Du leier en bil fast. Det blir fort veldig dyrt, det er mye som ikke er med i den prisen.
...
-	Har det vært utredet et budsjett? 
o	Nei. Innkjøp av bil kommer til å være genfors-sak, men det er greit å få innspill.
...
-	Det har vært diskutert pin for nodekomite også, det er billigere.
-	Det er en god ide det også, men vi har tradisjon å bare ha én pin, Online-pinen.
...
-	Vi er 19 stk.
-	Først noe eller ingenting:
o	Alle minus en vil ha noe
-	Unik dalje: 8
o	Hvis unik dalje:
	Plate: 15
	Helstøpt: 4
...
-	Abakusere har alle tilgang til kontoret sitt.
-	I Online praktiserer vi at kjernekomitemedlemmer har tilgang.
...
-	Hvis noen har nach, får vi vite hvem som har åpnet. 
o	Saksopplysning – da må vi politianmelde det.
...
-	Tilbakemelding til denne kvelden: blæstingen var kanskje ikke helt der oppe, heller ikke forberedelsene (for eksempel bil-punktet).
o	Hvordan skal vi gjøre det bedre? Pizza!
