...
- Innkalling: godkjent
- Servering: godkjent
- Referat: ikke godkjent (straff på jacob)

## 130 TODO´s fra forrige møte **✅**

- [x]  Brage: Fikser forslag til mal for signatur
- [x]  Erik: Installeringmail
- [x]  Frederik: Kalle inn til stormøte
- [ ]  Brage + Frederik: Se over wiki
- [x]  Erik: Poster invitasjoner
- [ ]  Erik: Sende mail til komiteer angående blæstekalender når nye er tatt opp
- [x]  Brage: Tilbakemeldingsskjema kompilering
- [x]  Brage: Velkom erfaringsskriv
- [x]  Brage: Kompilering erfaringsskriv
- [x]  Frederik: Sende melding om oppdatert prikkregler.
- [x]  Frederik: Sende informasjon om fordelingsmøte til komiteledere.
- [x]  Ida: tilbakemeldingsskjema for kompilering
...
- Fred: Brage kan snakke for meg på denne, vi har snakka bittelitt om d på slack og er enige i at det burde bli tatt opp leder og nestleder ganske asap
...
- Erik tar rollen som kontaktperson og ta opp leder og nestleder.

## 134 Agraffer og pins (10 min)

- Fred: Kan være lurt å telle kompileringsdaljer før vi evt bestiller dette. Vi burde ihvertfall ha bestilt nok slik at det er nok der for neste års opptak. Men ellers kjøh, backer så lenge vi har cash money og det blir bra.
...
- [ ]  lara sender mail til Eeman
- [x]  ida spør om prisen til de "gullgreiene"
- [ ]  Frederik sender melding til Scott om finansiering
- [ ]  Erik setter opp møte med rekom-dama
- [ ]  Jacob ser på overføring av midler for daljer
- [ ]  Erik sender mail til arrkom om pins
